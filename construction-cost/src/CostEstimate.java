...
public class CostEstimate {
	...
	public double getCost(double area, String materialType, boolean automation) throws InvalidMaterialSelect
	{
	 ...
	 public double getMaterialCost(String materialStandard, boolean automation) throws InvalidMaterialSelect
	 {
		 ...
		 {
			 boolean material=materialStandard.toLowerCase().contentEquals(MaterialStandards.Standards.HighStandardMaterial.toString().toLowerCase());
